...
const thingSchema = mongoose.Schema({
    ...
    dislakes: { type: Number, required: true },  // nombre d'utilisateurs qui n'aiment pas
    usersLiked: { type: ["String<userId>"], required: true },  // tableau des identifiants utilisateurs qui ont aimé
    usersDisliked: { type: ["String<userId>"], required: true },  // tableau des identifiants utilisateurs qui n'ont pas aimé
});
